...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-06-2019 a las 18:41:57
...
DROP PROCEDURE IF EXISTS `busquedaProducto`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `busquedaProducto` (IN `cod` INT)  SELECT* 
    FROM products
    WHERE ProductID=cod$$

DROP PROCEDURE IF EXISTS `consultaProducto`$$
