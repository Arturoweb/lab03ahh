...
class Producto 
{
	...
	public function Vista(){
			...
			$stm = $this->Pdo->prepare("call consultaProducto()");
					...
					if ($stm) {
						...
						$tabla = $tabla."<tr>".
								"<td class=cCodigo>". $Prod->Codigo ."</td>".
								"<td class=cNombreP>". $Prod->ProductName ."</td>".
								"<td>". $Prod->UnitPrice ."</td>".
								"<td>". $Prod->UnitsInStock ."</td>".
								"<td>". $Prod->CategoryName ."</td>".
								"<td>". $Prod->CompanyName ."</td>".
								"<td class=cEditar><a href='editarProducto.php?cod=". $Prod->ProductID."'>A</a></td>".
								"<td class=cEliminar><a href='eliminar.php?cod=". $Prod->ProductID."'>E</a></td>".
							 "</tr>";
						}
					}
					else{
	...
	public function Guardar(){
		...
		if ($resultado==true) {
			...
			echo "<p><a href='listaProductos.php'>Regresar al Listado</a></p>";
		}else {
